...
struct CollectiveMainloopFwd {
    ...
    mma(Params const& params,
        ...
        if constexpr (IntraWGOverlap) {
            ...
            // Probably creating a register variable here isn't optimal
            cute::copy(softmax.finalize(!Is_FP8 || params.ptr_v_descale == nullptr ? 1.f : params.ptr_v_descale[bidb]), scores_scale);
            warpgroup_wait<0>();
